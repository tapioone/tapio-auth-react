...
const App = () => {
  ...
  const email =
    (accounts[0]?.idTokenClaims as { email?: string } | undefined)?.email ?? "";
      ...
      <header className="App-header">
        ...
        <div className="App-nav">
          ...
          <a
            ...
            href="https://github.com/tapioone/tapio-auth-react"
          >
            <svg
      ...
      <main className="App-content">
        ...
        {!isAuthenticated && triedSilentLogin && (
          <>
            ...
            <p>
              This is a sample App for authentication against the tapio B2C for
              the tapio partners with the{" "}
              <strong>Authorization code flow with PKCE</strong>. You can log in
              here with your tapio account. For more information regarding the
              development please check the{" "}
              <a
                href="https://github.com/tapioone/tapio-auth-react"
                target="_blank"
                rel="noreferrer"
              ...
              and the{" "}
              <a
                href="https://developer.tapio.one/general/authentication"
                target="_blank"
                rel="noreferrer"
              >
                tapio developer portal
              </a>
              .
            </p>
          </>
        )}
        <h3>{isAuthenticated && "You are authenticated."}</h3>
        {accounts[0] && (
